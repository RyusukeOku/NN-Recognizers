...
from src.recognizers.automata.automaton_aalpy import AutomatonState, Automaton
from src.recognizers.automata.automaton_aalpy import OutputType, InputType
