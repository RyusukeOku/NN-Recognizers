...
from src.recognizers.automata.Onfsm import Onfsm
from src.recognizers.automata.NonDeterministicMooreMachine import NDMooreMachine
from src.recognizers.automata.GeneralizedStateMerging import run_GSM
from src.recognizers.automata.Instrumentation import ProgressReport
from src.recognizers.automata.GsmNode import GsmNode
from src.recognizers.automata.ScoreFunctionsGSM import ScoreCalculation, hoeffding_compatibility, \
    ScoreWithKTail
from src.recognizers.learning_algs.HelperFunctions import dfa_from_moore
...
def run_Alergia_EDSM(data, automaton_type, eps=0.05, print_info=False):
    ...
    Returns:
        ...
        A Mc, Mdp or SMM
    """
    from src.recognizers.learning_algs.HelperFunctions import mc_format_to_mdp, mc_from_mdp
